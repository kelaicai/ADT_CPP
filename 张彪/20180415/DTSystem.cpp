...
{
	{ OPERATE_LINK, &DTSystem::operationLink },
	{ OPERATE_STACK, &DTSystem::operationStack },
	{ OPERATE_QUEUE, &DTSystem::operationStack },
	{ OPERATE_QUIT, &DTSystem::operationQuit },
};
